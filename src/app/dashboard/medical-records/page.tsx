...
// Temporarily disabled for deployment - will re-enable after successful deploy
...
export default function MedicalRecordsPage() {
  ...
  return (
    // Temporarily disabled RoleGuard for deployment - TODO: Re-enable after successful deploy
